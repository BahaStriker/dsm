<div class="modal-header">
    ...
    <h4 class="modal-title"><?php _e('Install Devrows Server Agent'); ?></h4>
</div>

<div class="modal-body">

    <h4><?php _e('Follow the steps below to install the Devrows Windows Agent on this server:'); ?></h4>

    <p><b>1.</b> <?php _e('Download agent installer from '); ?> <a href="./assets/Devrows-agent-latest.exe"><?php _e('here'); ?></a> <?php _e('and install on your server.'); ?>.</p>

    <p><b>2.</b> <?php _e('Open Devrows Agent after installation finishes.'); ?>.<br></p>
