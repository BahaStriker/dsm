<div class="modal-header">
    ...
    <h4 class="modal-title"><?php _e('Edit Website'); ?></h4>
</div>
        ...
        <div class="row" id="more-form" style="display:none">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lat" name="lat" placeholder="<?php _e('Latitude'); ?>" value="<?php echo $website['lat']; ?>" data-validation="number" data-validation-optional="true" data-validation-allowing="range[-90.0;90.0],float,negative" data-validation-error-msg="<?php _e('Invalid Latitude Value'); ?>">
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="lng" name="lng" placeholder="<?php _e('Longitude'); ?>" value="<?php echo $website['lng']; ?>" data-validation="number" data-validation-optional="true" data-validation-allowing="range[-180.0;180.0],float,negative" data-validation-error-msg="<?php _e('Invalid Longitude Value'); ?>">
                </div>
            </div>
                ...
                <div class="form-group">
                    <div class="checkbox">
                        <label>
                            ...
                            <input type="checkbox" name="on_map" id="on_map" <?php if($website['on_map'] == "1") echo 'checked="yes"'; ?>  value="1"> <?php _e('Show on map'); ?>
                        </label>
                    </div>
